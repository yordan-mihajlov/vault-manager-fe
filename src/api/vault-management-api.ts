...
export class VaultManagementApi {
    ...
    public static readonly GET_CONFIG_DATA: string = `${API_URL}/api/config/get-configs`;
    public static readonly UPDATE_CONFIG_CONFIGS: string = `${API_URL}/api/config/update-configs`;
